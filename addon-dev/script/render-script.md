...
<table border="1" class="dense">
    ...
    <tr>
        <td><b>getTick</b>(<span style="color:#ff77ff;">Entity par1</span>)</td>
        <td><span style="color:#ffff66;">int</span></td>
        <td>Tickを取得</td>
        <td></td>
    </tr>
    <tr>
        <td><b>getWheelRotationR</b>(<span style="color:#ff77ff;">Entity entity</span>)</td>
        <td><span style="color:#ffff66;">float</span></td>
        <td>車輪の回転(0-360) JSONの"wheelRotationSpeed"に依存</td>
        <td>乗り物専用</td>
    </tr>
    <tr>
        <td><b>getDoorMovementR</b>(<span style="color:#ff77ff;">Entity entity</span>)</td>
        <td><span style="color:#ffff66;">float</span></td>
        <td>ドア移動(0.0-1.0)</td>
        <td>乗り物専用</td>
    </tr>
    <tr>
        <td><b>getPantographMovementFront</b>(<span style="color:#ff77ff;">Entity entity</span>)</td>
        <td><span style="color:#ffff66;">float</span></td>
        <td>パンタグラフ上下(0.0-1.0)</td>
        <td>乗り物専用</td>
    </tr>
    <tr>
        <td><b>getPantographMovementBack</b>(<span style="color:#ff77ff;">Entity entity</span>)</td>
        <td><span style="color:#ffff66;">float</span></td>
        <td>後部パンタグラフの動き(0.0-1.0)</td>
        <td>近鉄線専用</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><span style="color:#ffff66;">int</span></td>
        <td>最軽量の時の値を(-1 or 1)</td>
        <td>電磁靴専用</td>
    </tr>
    <tr>
        <td><b>GL11.glPushMatrix</b>()</td>
        <td><span style="color:#00ff99;">void</span></td>
        <td>現在の座標系を保存&amp;押し出し</td>
        <td></td>
    </tr>
    <tr>
        <td><b>GL11.glPopMatrix</b>()</td>
        <td><span style="color:#00ff99;">void</span></td>
        <td>座標系を変更</td>
        <td></td>
    </tr>
